...
class AdminMails extends Mailable
{
    ...
    public function __construct($mailContents)
    {
        ...
        $this->username = $mailContents['username'];
    }
    ...
    {
        return $this->subject($this->subject)->markdown('mails.mailtemplate')->with(['username'=>$this->username,'body'=>$this->body,'password'=>$this->password,'footer'=>$this->footer]);
    }
}
