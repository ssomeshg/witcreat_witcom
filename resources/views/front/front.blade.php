...
<section class="homeslider-section">
   <div class="homeslider-inner mobileslidehide">
      ...
      <div class="homeslider one">
         <a href="{{ $front->bannerLink }}"><img src="{{ asset('/assets/media/banner/' . $front->web_image) }}"
               class="img-responsive" alt="{{ $front->web_image }}"></a>
      </div>
      @endforeach
   </div>
   <div class="homeslider-inner mobileslide">
      @foreach ($frontBanner as $front)
      <div class="homeslider one">
         <a href="{{ $front->bannerLink }}"><img
               src="{{ asset('/assets/media/banner/' . $front->mobile_image) }}" class="img-responsive"
               alt="{{ $front->mobile_image }}"></a>
      </div>
      @endforeach
   </div>
</section>
   ...
   <div class="product-section">
      <div class="container">
         <div class="product-title">
            <h1>Our Product</h1>
            <a href="{{ route('front.getCategory') }}">View All <img
                  src="{{ URL::asset('assets/media/banner/arrow.png') }}" alt=""></a>
         </div>
      </div>
               ...
               <div class="col-md-3">
                  <div class="arrival-items">
                     ...
                     <div class="arrival-price">
                        ...
                        <div class="price-sec">
                           <span
                              class="price">{{ $store->currencysymbol() ? $store->currencysymbol() : 'Rs.' }}
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="c-title">
               <div class="arrival-title">
                  <h1>Collections</h1>
                  <a href="">View All <img src="{{ URL::asset('assets/media/banner/arrow.png') }}"
                        alt=""></a>
      ...
      <div class="row" style="position: relative; display: flex;">
         <div class="col-md-5">
            <div class="fashion-left">
               <div class="fs-shop">
                  <img src="{{ URL::asset('assets/media/fash.png') }}" alt="">
               </div>
               <img class="fs-logo" src="{{ URL::asset('assets/media/logo5.png') }}" alt="">
            </div>
         </div>
         <div class="col-md-7">
                                    ...
                                    <div class="featured-slider">
                                       ...
                                       <div class="featured-single">
                                          <div class="featureditem-inner">
                                             <div class="featuredsingle-img">
                                                <img src="{{ URL::asset('assets/media/banner/' . $category2->category_banner) }}"
                                                   class="img-responsive" alt="{{ $category2->category_name }}">
                                                <div class="foverlay-content">
                                                   <div class="foverlay-outer">
                                                      <div class="foverlay-inner text-center">
                                                         <div class="shopnow-wrap">
                                                            <a class="shopnow-btn"
                                                               href="{{ route('front.getCategory', ['category' => $category2->Category_url]) }}">
                                                               Shop Now</a>
                                                         </div>
                                                         <div class="fcatname">
                                 ...
                                 <div class="col-md-12 col-sm-12 col-xs-12 nopad prdslider-wraper commontab-wraper homeslide">
                                    <div class="product-slider">
                                       ...
                                       <div class="prd-single">
                                          <div class="prd-inner">
                                             <div class="prd-img">
                                                <a href="{{ route('product.item', ['slug' => $discountProduct->slug]) }}"><img
                                                      src="{{ URL::asset('/assets/media/products/' . $discountProduct->image1) }}"
                                                      class="img-responsive" alt="{{ $discountProduct->image1 }}"></a>
                                             </div>
                                             @php
                                             ...
                                             <div class="prdbtn-wraper">
                                                <ul class="list-inline">
                                                   <li><a href="" data-id="{{ $discountProduct->id }}"
                                                         data-q="{{ $discountProduct->minquantity }}"
                                                         class="cart-btn common-btn btn-cart2 {{ $discountProduct->soldout != 'off' ? 'p-e-none' : '' }}"
                                                         data-toggle="tooltip" data-placement="top"
                                                         title="{{ $discountProduct->soldout != 'off' ? 'soldout' : 'Add to Cart' }}">{{ $discountProduct->soldout != 'off' ? 'soldout' : 'Add to Cart' }}</a>
                                                   </li>
                                                   <li><a href="" data-id="{{ $discountProduct->id }}"
                                                         class="wishlist-btn common-btn  btn-wishlist {{ in_array($discountProduct->id, $array) ? 'added' : '' }}"
                                             ...
                                             <div class="prdname-wraper">
                                                   ...
                                                   <div class="ratings-full">
                                                      ...
                                                      <span class="tooltiptext tooltip-top">
                                                         <div class="star_rating">
                                                            <span
                                                               class="fa fa-star {{ $star >= 1 ? 'checked' : '' }}"></span>
                                                            <span
                                                               class="fa fa-star {{ $star >= 2 ? 'checked' : '' }}"></span>
                                                            <span
                                                               class="fa fa-star {{ $star >= 3 ? 'checked' : '' }}"></span>
                                                            <span
                                                               class="fa fa-star {{ $star >= 4 ? 'checked' : '' }}"></span>
                                                            <span
                                                               class="fa fa-star {{ $star >= 5 ? 'checked' : '' }}"></span>
                                                         </div>
                                                      </span>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="detailsprice-wraper">
                                                   <div class="prdprice-wraper">
                                                      ...
                                                      <span
                                                         class="original-price">{{ $StoreConfig->currencysymbol() ? $StoreConfig->currencysymbol() : 'Rs.' }}
                                                         {{ $data->VendorPrice }}</span>
                                                      <span class="offer-percent">
                                                         (@if (!empty($data->discount))
                                                         {{ $data->discount->number }}{{ $data->discount->type == '%' ? '%' : 'Rs' }}
                                                         OFF
                                                         @endif
                                                         @if (!empty($data->CustomerGroup) && $data->CustomerGroup->amount != 0)
                                                         @if (!empty($data->discount))
                                                         &
                                                         @endif
                                                         {{ $data->CustomerGroup->amount }}{{ $data->CustomerGroup->type == 1 ? '%' : 'Rs' }}
                                                         OFF
                                                         @endif)
                                                      </span>
                                                      @endif
                              ...
                              <div class="row mobileres">
                                 <div class="col-md-3 col-sm-3 col-xs-6 shopby-single mob-padr-5">
                                    <a href="{{ route('front.getCategory') }}?min=0&max=2000" class="shopby-inner">
                                       <div class="shopby-img">
                                          <img src="{{ URL::asset('assets/front/images/shopby1.jpg') }}"
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-6 shopby-single mob-padl-5">
                                    <a href="{{ route('front.getCategory') }}?min=2000&max=5000" class="shopby-inner">
                                       <div class="shopby-img">
                                          <img src="{{ URL::asset('assets/front/images/shopby2.jpg') }}"
                                             class="img-responsive" alt="slider2">
                                          <div class="shopby-price">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-6 shopby-single mob-padr-5">
                                    <a href="{{ route('front.getCategory') }}?min=5000&max=8000" class="shopby-inner">
                                       <div class="shopby-img">
                                          <img src="{{ URL::asset('assets/front/images/shopby3.jpg') }}"
                                             class="img-responsive" alt="slider2">
                                          <div class="shopby-price">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-6 shopby-single mob-padl-5">
                                    <a href="{{ route('front.getCategory') }}?min=8000&max=50000" class="shopby-inner">
                                       <div class="shopby-img">
                                          <img src="{{ URL::asset('assets/front/images/shopby4.jpg') }}"
                                             class="img-responsive" alt="slider2">
                                          <div class="shopby-price">
                           ...
                           <div class="row mobileres">
                              <div class="col-md-3 col-sm-3 col-xs-12 newarrival-single">
                                 <div class="col-md-12 col-sm-12 col-xs-12 nopad newarrival-thumb">
                                    <a href="{{ route('front.getCategory', ['category' => $Homecat3[0]['category'][0]->Category_url]) }}"
                                       class="newarrival-inner overlay-wrap">
                                       <div class="newarrival-img">
                                          <img src="{{ URL::asset('assets/media/banner/' . $Homecat3[0]['category'][0]->style_3) }}"
                                             class="img-responsive"
                                             alt="{{ $Homecat3[0]['category'][0]->category_name }}">
                                 ...
                                 <div class="col-md-12 col-sm-12 col-xs-12 nopad newarrival-thumb mobmgn">
                                    <a href="{{ route('front.getCategory', ['category' => $Homecat3[0]['category'][1]->Category_url]) }}"
                                       class="newarrival-inner overlay-wrap">
                                       <div class="newarrival-img">
                                          <img src="{{ URL::asset('assets/media/banner/' . $Homecat3[0]['category'][1]->style_3) }}"
                                             class="img-responsive"
                                             alt="{{ $Homecat3[0]['category'][1]->category_name }}">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12 newarrival-single newarrival-middle mobmgn">
                                 <a href="{{ route('front.getCategory', ['category' => $Homecat3[0]['category'][2]->Category_url]) }}"
                                    class="newarrival-inner overlay-wrap">
                                    <div class="newarrival-img">
                                       <img src="{{ URL::asset('assets/media/banner/' . $Homecat3[0]['category'][2]->style_3) }}"
                                          class="img-responsive"
                                          alt="{{ $Homecat3[0]['category'][2]->category_name }}">
                              ...
                              <div class="col-md-3 col-sm-3 col-xs-12 newarrival-single">
                                 <div class="col-md-12 col-sm-12 col-xs-12 nopad newarrival-thumb">
                                    <a href="{{ route('front.getCategory', ['category' => $Homecat3[0]['category'][3]->Category_url]) }}"
                                       class="newarrival-inner overlay-wrap">
                                       <div class="newarrival-img">
                                          <img src="{{ URL::asset('assets/media/banner/' . $Homecat3[0]['category'][3]->style_3) }}"
                                             class="img-responsive"
                                             alt="{{ $Homecat3[0]['category'][3]->category_name }}">
                                 ...
                                 <div class="col-md-12 col-sm-12 col-xs-12 nopad newarrival-thumb">
                                    <a href="{{ route('front.getCategory', ['category' => $Homecat3[0]['category'][4]->Category_url]) }}"
                                       class="newarrival-inner overlay-wrap">
                                       <div class="newarrival-img">
                                          <img src="{{ URL::asset('assets/media/banner/' . $Homecat3[0]['category'][4]->style_3) }}"
                                             class="img-responsive"
                                             alt="{{ $Homecat3[0]['category'][4]->category_name }}">
                           ...
                           <div class="row">
                              <div class="col-md-2 col-sm-2 col-xs-12 icon-single">
                                 <a href="" class="icon-inner">
                                    <div class="icon-img">
                                       <span><img src="{{ URL::asset('assets/images/icons/i1.png') }}"
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12 icon-single">
                                 <a href="" class="icon-inner">
                                    <div class="icon-img">
                                       <span><img src="{{ URL::asset('assets/images/icons/i2.png') }}"
                                             class="img-responsive center-block" alt="slider2"></span>
                                    </div>
                                    <div class="icon-name">
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12 icon-single">
                                 <a href="" class="icon-inner">
                                    <div class="icon-img">
                                       <span><img src="{{ URL::asset('assets/images/icons/i3.png') }}"
                                             class="img-responsive center-block" alt="slider2"></span>
                                    </div>
                                    <div class="icon-name">
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12 icon-single">
                                 <a href="" class="icon-inner">
                                    <div class="icon-img">
                                       <span><img src="{{ URL::asset('assets/images/icons/i4.png') }}"
                                             class="img-responsive center-block" alt="slider2"></span>
                                    </div>
                                    <div class="icon-name">
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12 icon-single">
                                 <a href="" class="icon-inner">
                                    <div class="icon-img">
                                       <span><img src="{{ URL::asset('assets/images/icons/cod.jpg') }}"
                                             class="img-responsive center-block" alt="slider2"></span>
                                    </div>
                                    <div class="icon-name">
                                       <span>COD</span>
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12 icon-single">
                                 <a href="" class="icon-inner">
                                    <div class="icon-img">
                                       <span><img src="{{ URL::asset('assets/images/icons/return.png') }}"
                                             class="img-responsive center-block" alt="slider2"></span>
                                    </div>
                                    <div class="icon-name">
                                       <span>Return</span>
