                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-pincode-store')}}" enctype="multipart/form-data" id="formCreate">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                   ...
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="text" value="" id="pincode" name="pincode" />
                                                        </div>
                                                    </div>
 ...
 <script>
   ...
   $("#stateName").change(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                $.each(data, function(index, element) {
                $("#cityName").append('<option value="'+element["id"]+'">'+element["city_name"]+'</option');
