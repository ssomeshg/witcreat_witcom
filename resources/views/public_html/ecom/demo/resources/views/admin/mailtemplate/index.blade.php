                                ...
                                <div class="card card-custom gutter-b">
                                    <div class="card-header flex-wrap py-3">
                                        <div class="card-title">
                                            <h3 class="card-label">List of Templates</h3>
                                        </div>
                                        <div class="card-toolbar">

                                            <!--begin::Button-->
                                            <a href="{{route('admin-mailtemplate-create')}}" class="btn btn-primary font-weight-bolder">
 ...
 @push('script')                  
     <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               processing: false,
               serverSide: true,
               ajax: "{{ route('admin-mailtemplate-datatables') }}",
               columns: [
                        { data: 'DT_RowIndex', name: 'DT_RowIndex'},
                        { data: 'template_name', searchable: false, orderable: false },
                        { data: 'bcc_mail', name: 'bcc_mail' },
                        { data: 'subject_mail', name: 'subject_mail' },
