                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                           ...
                                           <div class="alert alert-danger alert-dismissible fade show" style="display:none" role="alert">
                                            ...
                                            <form method="POST" action="{{route('admin-shipping-store')}}" enctype="multipart/form-data" id="formCreate">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-3">
                                                            <input class="form-control" type="number" value="" id="CODAmount" name="CODAmount" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Weight<span class="text-danger">*</span></label>
                                                        <div class="col-2">
                                                            <input class="form-control" type="number" value="" id="weight[]" name="weight[]" placeholder="KG" required/>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                            <input data-switch="true" type="checkbox" checked="checked" data-on-color="success" data-off-color="danger" value="1" id="type" name="type" checked/>
                                                        </div>
                                                    </div>
