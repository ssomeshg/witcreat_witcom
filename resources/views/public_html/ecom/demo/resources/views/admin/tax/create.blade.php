                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-tax-store')}}" enctype="multipart/form-data" id="formCreate" onsubmit="CKEditor5.updateSourceElement();">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-3">
                                                            <input class="form-control" type="text" value="" id="taxName" name="taxName" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                        <textarea name="taxDescription" id="ktckeditor"></textarea>
                                                <div class="fv-plugins-message-container"></div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-3">
                                                            <input class="form-control" type="number" value="" id="taxRate" name="taxRate" />
                                                        </div>
                                                    </div>
