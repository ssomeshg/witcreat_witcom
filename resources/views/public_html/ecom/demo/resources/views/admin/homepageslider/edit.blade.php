...
@section('content')  
                                                ...
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                            <div class="radio-inline">
                                                                <label class="radio radio-success">
                                                                    <input type="radio" name="type"{{$data->type != 'All' ? 'checked' : ''}} value='1' onclick="show(this)"/>
                                                                    <span></span>
                                                                    Single Category
                                                                </label>
                                                                <label class="radio radio-success">
                                                                    <input type="radio" name="type" {{$data->type == 'All' ? 'checked' : '' }} value='0' onclick="show(this)"/>
                                                                    <span></span>
                                                                    All Category
                                                                </label>
                                                            </div>
                                                     ...
                                                     <div class="form-group row" style="{{$data->type != 'All' ? '' : 'display:none'}}" id="category">
 ...
 <script>
    ...
    $.post('{{route('admin-homeslider-load')}}',{"_token": "{{ csrf_token() }}",data:$("#choices-multiple-remove-button").val()},function(data,status){
            $('#table').html(data);
