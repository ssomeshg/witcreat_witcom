                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-vendor-update',$data->id)}}" id="formEdit" onsubmit="CKEditor1.updateSourceElement();">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text"  id="name" name="name" required value="{{ $data->name}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-3">
                                                            <input class="form-control" type="text" id="manufacturerID" maxlength="5" value="{{ $data->manufacturerID}}" name="manufacturerID" required/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <select class="form-control form-control-solid form-control-lg country" id="billingCountry" name="billingCountry" required>
                                                           <option disabled selected>Select Country</option>
                                                            ...
                                                            <option value="{{$countries->id}}" {{($data->billingCountry == $countries->id )?'selected':'' }}>{{$countries->country_name}}</option>
                                                           @endforeach
                                                        </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <select class="form-control states form-control-solid form-control-lg" id="billingState" name="billingState" required>
                                                           <option disabled selected>Select State</option>
                                                            @foreach($state as $states)
                                                               <option value="{{$states->id}}" {{($data->billingState == $states->id )?'selected':'' }}>{{$states->state_name}}</option>
                                                              @endforeach
                                                            </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <select class="form-control form-control-solid city form-control-lg" id="billingCity" name="billingCity" required>
                                                           <option disabled selected>Select City</option>
                                                            @foreach($city as $cities)
                                                               <option value="{{ $cities->id }}" {{($data->billingCity == $cities->id )?'selected':'' }}>{{$cities->city_name}}</option>
                                                              @endforeach
                                                            </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <select class="form-control pincode form-control-solid form-control-lg" id="pincode" name="pincode" required>
                                                           <option disabled selected>select Pincode</option>
                                                            ...
                                                            <option value="{{$pincodes->id}}"  {{($data->pincode == $pincodes->id )?'selected':'' }}>{{$pincodes->pincode}}</option>
                                                            @endforeach
                                                            </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger"></span></label>
                                                        <div class="col-10">
                                                           <textarea name="address" id="ktckeditor1">{{$data->address}}</textarea>
                                                           <div class="fv-plugins-message-container"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row " id="require" style="{{($data->type === 'Company')?'':'display:none' }}">
                                                        <label class="col-2 col-form-label " >GST NO
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="{{ $data->gstNo }}" id="gstNo" name="gstNo" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row" id="require">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-2">
                                                            <input class="form-control" type="text" value="{{$data->vendorperscent}}" id="vendorperscent" name="vendorperscent" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="email" value="{{ $data->email }}" id="email" name="email" placeholder="example@email.com", pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Invalid email address"  required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="{{ $data->contact }}" id="contact" name="contact" pattern="[0-9]+" title="Number Only Accept" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <select class="form-control" id="role_id" name="role_id" required>
                                                           ...
                                                           @foreach ($Role as $C )
                                                            <option value="{{ $C->id }}" {{($data->role_id == $C->id )?'selected':'' }}>{{$C->role_name}}</option>
                                                           @endforeach
                                                        </select>
                                                        </div>
                                                    </div>
