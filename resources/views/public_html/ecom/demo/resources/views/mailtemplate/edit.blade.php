                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-mailtemplate-update',$data->id)}}" enctype="multipart/form-data" id="formEdit" onsubmit="CKEditor5.updateSourceElement();CKEditor51.updateSourceElement();">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            ...
                                                            <option value="{{ $data1->id}}" {{ ($data1->id == $data->template_name)? 'selected' :'' }}>{{$data1->template_name}}</option>
                                                            @endforeach
                                                        </select>
                                                        </div>
                                                    </div>
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="text" value="{{ $data->bcc_mail}}" id="mailBcc" name="mailBcc" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="text" value="{{$data->subject_mail}}" id="mailSubject" name="mailSubject" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                        <textarea name="mailContent" id="kt-ckeditor">{{$data->content_mail}}</textarea>
                                                <div class="fv-plugins-message-container"></div>
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                        <textarea name="mailFooter" id="kt-ckeditor1" >{{$data->footer_mail}}</textarea></div>
                                                    </div>
