                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                           ...
                                           <div class="alert alert-danger alert-dismissible fade show" style="display:none" role="alert">
                                            ...
                                            <form method="POST" action="{{route('admin-customergroup-store')}}" enctype="multipart/form-data" id="formCreate">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                       ...
                                                       <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="number" value="" id="amount" name="amount" />
                                                        </div>
                                                    </div>
