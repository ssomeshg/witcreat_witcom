...
<html lang="en">
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            ...
            <a href="{{ route('admin.dashboard')}}">
                <img alt="Logo" src="{{URL::asset('assets/media/banner/'.$StoreConfig->logo)}}" class="logo" style="min-width:30px"/>
            </a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <a href="{{ route('admin.dashboard')}}" class="brand-logo">
                            <img alt="Logo" src="{{asset('assets/media/banner/'.$StoreConfig->logo)}}" style="max-width: 120px;"/>
                        </a>
                        <!--end::Logo-->
                        <!--begin::Toggle-->
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            ...
                            <ul class="menu-nav">
                                ...
                                @foreach($frontMenu as $FrontMenu)
                                @php
                                $menu = false;
                                ...
                                @endphp
                                <li class="menu-item menu-item-parent {{($menu)?'menu-item-open menu-item-here':''}}" aria-haspopup="true" data-menu-toggle="hover">
                                    ...
                                    <div class="menu-submenu">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item {{(Request::url() == route($subMenus->module_path))?'menu-item-active':'menu-item-submenu'}}" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="{{route($subMenus->module_path)}}" class="menu-link menu-toggle">
                                                    <i class="menu-bullet menu-bullet-line">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">{{$subMenus->module_name}}</span>
                                                </a>
                                            </li>
                                            @endif
                                                @endforeach
                                ...
                                @endphp
                                @foreach($frontMenu as $FrontMenu)
                                @if(in_array($FrontMenu->id,$testArr))
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="topbar">
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                        ...
                                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ ucfirst(Auth::user()->admin_name) }}</span>
                                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                            <span class="symbol-label font-size-h5 font-weight-bold">{{ ucfirst(substr(Auth::user()->admin_name,0,1)) }}</span>
                                        </span>
                                    </div>
                                </div>
                                <!--end::User-->
                    ...
                    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="text-dark order-2 order-md-1">
                                <span class="text-muted font-weight-bold mr-2">Tailored By Latha @ 2024 </span>
                                <a href="thesilkastic.com/demo/admin" target="_blank" class="text-dark-75 text-hover-primary">All Rights Reserved | Designed & Developed by GPS Infotech</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Nav-->
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    ...
                    <div class="d-flex flex-column">
                        <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{auth()->user()->admin_name.''.auth()->user()->last_name}}</a>
                        <div class="text-muted mt-1">{{(auth()->user()->is_vendor == null)?'Admin':'Vendor'}}</div>
                        <div class="navi mt-2">
                            <a href="#" class="navi-item">
                                <span class="navi-link p-0 pb-2">
                                    ...
                                    <span class="navi-text text-muted text-hover-primary">{{auth()->user()->admin_email}}</span>
                                </span>
                            </a>
        ...
        <script src="{{ URL::asset('assets/js/pages/crud/file-upload/dropzonejs.js') }}"></script>
        <script src="{{ URL::asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}"></script>
        <script src="{{ URL::asset('assets/js/pages/crud/forms/editors/ckeditor-classic.js') }}"></script>
        <script src="{{ URL::asset('assets/js/croppie.js') }}"></script>
        <!--end::Page Scripts-->
        <script src="{{ URL::asset('assets/js/jquery.nice-select.min.js')}}"></script>
        <script src="{{ URL::asset('assets/js/pages/custom/wizard/wizard-1.js')}}"></script>
