            ...
            $url=route('admin-product-cropimage');
                        ...
                        <form method="POST" action="{{$link}}" enctype="multipart/form-data" id="formEdit" onsubmit="if(typeof CKEditor1 != 'undefined'){ CKEditor1.updateSourceElement(); } if(typeof CKEditor4 != 'undefined'){ CKEditor4.updateSourceElement(); } CKEditor2.updateSourceElement();CKEditor3.updateSourceElement();">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-3">
                                    <select name="markup_type" class="form-control" id="markup_type">
                                        <option value="0" {{ ($product->markup_type == '0') ? 'selected' : '' }}>%</option>
                                        <option value="1" {{ ($product->markup_type == '1') ? 'selected' : '' }}>Flat</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <div class="input-group">
                                        <input class="form-control" onkeyup="markupPrice(this.value)"  type="number" value="{{$product->markup}}" id="markup" name="markup" required/>
                                        <div class="input-group-append"><span class="input-group-text" id="markup_span">{{ ($product->markup_type == '0') ? '%' : 'Flat' }}</span></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <label for="image1"  ><img class="file-preview" style="width:250px;border:2px dashed #222;height: 310px"  src="{{ URL::asset('assets/media/products/'.$product->image1) }}">
