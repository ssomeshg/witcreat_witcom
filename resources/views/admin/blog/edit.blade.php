                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-blog-update',$data->id)}}" enctype="multipart/form-data" id="formEdit">
                                                {{ csrf_field() }}
                                                ...
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="text" value="{{$data->blog_url}}" id="blog_url" name="blog_url" required/>
                                                        </div>
                                                    </div>    
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="radio-inline">
															<label class="radio">
															<input type="radio" name="blog_type" id="image_type" {{ ($data->blog_type== 0) ?  "checked" : ""   }} value="0">
															<span></span>Image</label>
															<label class="radio">
															<input type="radio" name="blog_type"  id="video_type" {{ ($data->blog_type== 1) ?  "checked" : ""   }} value="1">
															<span></span>Video</label>
														</div>
                                                     </div>             
                                                     <div class="form-group row {{ ($data->blog_type== 0) ?'' :'d-none'}}" id="image_ids">
                                <label class="col-2 col-form-label">Blog image<span class="text-danger">*</span> </label>
                                <div class="col-3">
                                    <label for="blog_image"  >
                                        <img class="file-preview" style="width:250px;border:2px dashed #222;height: 310px"  src="{{ URL::asset('assets/media/banner/'.$data->blog_image) }}">
                                    ...
                                    <span class="form-text text-muted">Image width and height:255*255</span>
                                </div>
                            </div>                            
                                                    <div class="form-group row {{ ($data->blog_type== 1) ?'' :'d-none'}}"  id="video_ids">
                                                         <label class="col-2 col-form-label">Blog Video Url
                                                         <span class="text-danger">*</span></label>
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="{{$data->blog_video}}" id="blog_video" name="blog_video" requied />
                                                         </div>
                                                     </div>   
                                                    <div class="form-group row">
                                                         ...
                                                         <span class="text-danger">*</span></label>
                                                         <div class="col-10">
                                                            <textarea name="blog_content" id="kt-ckeditor-4" >{{$data->blog_content}}</textarea>
                                ...
                                <label class="col-2 col-form-label">Home Flag</label>
                                    ...
                                    <input data-switch="true" type="checkbox"  data-on-color="success" data-off-color="danger" name="home_flag" value="1" {{ ($data->home_flag == '1') ? 'checked' : '' }} />
                                </div>
                            </div>
