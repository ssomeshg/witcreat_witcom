                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-discount-store')}}"  id="formCreate">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="0" id="number" name="number" required/>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                            <input data-switch="true" type="checkbox" name="show_home" data-on-color="success" data-off-color="danger"  />
                                                        </div>
                                                    </div>          
                                                    <div class="form-group row">                                                         
...
jQuery(document).ready(function() {
    ...
    // }
    jQuery('.alert-success div').bind('DOMSubtreeModified',function(event) { 
        location.reload();
    });
    </script>
 @endpush