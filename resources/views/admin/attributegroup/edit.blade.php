                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            <div class="card-header">
                                                <h3 class="card-title">Edit Attribute Group</h3>
                                            ...
                                            <form method="POST" action="{{route('admin-attributegroup-update',$data->id)}}" enctype="multipart/form-data" id="formEdit" onsubmit="CKEditor5.updateSourceElement();">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="{{$data->attribute_group_name }}" id="attributeGroupName" name="attributeGroupName" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <textarea name="descriptionGroup" id="kt-ckeditor" >{{$data->attribute_description }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="{{$data->attribute_sorting }}" id="attributeGroupSort" name="attributeGroupSort" required>
                                                        </div>
                                                    </div>
