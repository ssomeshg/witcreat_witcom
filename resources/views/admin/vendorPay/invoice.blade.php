                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between text-white pt-6">
                        <div class="d-flex flex-column flex-root">
                            ...
                            <span class="opacity-70">SKVP{{sprintf('%03d',$VendorPayment->id )}}</span>
                            <span class="opacity-70">{{ date_format($VendorPayment->created_at,'Y-M-d') }}</span>
                            <span class="opacity-70">Ref No {{ $data->TID}}</span>
                        </div>
                        <div class="d-flex flex-column flex-root">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="pr-0 font-weight-bold text-muted text-uppercase">Tax</th>
                            ...
                            <tbody>
                                ...
                                <tr class="font-weight-boldest font-size-lg">
                                    <td class="pl-0 pt-7 text-right"><img src="{{URL::asset('/assets/media/products/'.$item->image1)}}" class="img-responsive" alt="slider2" style="width: 50px;"></td>
                                    <td class="pl-1 pt-7 text-right">{{ $item->product_title }}</td>
                                    <td class="pl-0 pt-7 text-right">{{ $item->manufacturerPrice }}</td>
                                    <td class="pl-0 pt-7 text-right">{{ $item->ProductDiscount }}</td>
                                    <td class="pl-0 pt-7 text-right">{{ $item->quantity }}</td>
                                    <td class="pl-0 pt-7 text-right">{{ round($item->ProductTax * $item->quantity,2) }}( {{$item->producttax->tax_rate}} {{($item->producttax->tax_type == 1)?'%':'Rs'}})</td>
                                    <td class="pl-0 pt-7 text-right">{{ round($item->ProductDiscount * $item->quantity + $item->ProductTax * $item->quantity,2) }}</td>
                                </tr>
                                @endforeach
                                ...
                                <tr class="font-weight-boldest font-size-lg">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="text-right pt-7">(+/-) Less</td>
                                    <td class="text-danger pr-0 pt-7 text-right">{{$data->Less}}</td>
                                </tr>
                ...
                <div class="col-md-9">
                    <div class="d-flex justify-content-between flex-column flex-md-row font-size-lg">
                        ...
                        <div class="d-flex flex-column text-md-right">
                            ...
                            <span class="font-size-h2 font-weight-boldest text-danger mb-1">{{ $data->FinalPrice }}</span>
                        </div>
                    </div>
                </div>
            </div>
