                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="{{route('admin-city-update',$data->id)}}" enctype="multipart/form-data" id="formEdit">
                                                {{ csrf_field() }}
                                                <div class="card-body">
                                                   ...
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="{{$data->city_name}}" id="cityName" name="cityName" required>
                                                        </div>
                                                    </div>
