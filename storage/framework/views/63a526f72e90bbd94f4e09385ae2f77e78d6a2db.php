			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="showroom-details">
						...
						<div class="showroom-address">
							<span><?php echo $StoreConfig->location_address; ?></span>
						</div>
				...
				<div class="col-md-6 col-sm-6 col-xs-12 contactform-wraper">
					...
					<form  id="contactusforms"  action="<?php echo e(route('front.contact')); ?>" method="post">
...
<?php echo $__env->make('front.includes.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/front/contactus.blade.php ENDPATH**/ ?>