			...
			<div class="login-box">
				<div class="login-navbar">
					<ul class="nav-justified list-inline" role="tablist">
						<li role="presentation" class="<?php echo e((isset($_GET['r']))?'':'active'); ?>" ><a href="#login" aria-controls="login" role="tab" data-toggle="tab" aria-expanded="false">Login</a></li>
						<li role="presentation" class="<?php echo e((isset($_GET['r']))?'active':''); ?>"><a href="#register" aria-controls="register" role="tab" data-toggle="tab" aria-expanded="true">Register</a></li>
					</ul>

					<div class="tab-content">
						<div role="tabpanel" class="tab-pane <?php echo e((isset($_GET['r']))?'':'active'); ?>" id="login">
							<div class="loginform-wraper">
								<form method="post"  id="formlogin" action="<?php echo e(route('front.login')); ?>" method="POST" name="">
                                    <?php echo csrf_field(); ?>
									<div class="fieldset">
						...
						<div role="tabpanel" class="tab-pane <?php echo e((isset($_GET['r']))?'active':''); ?>" id="register">
							<div class="loginform-wraper" v-show="!otp">
								<form method="post" ref="form"  @submit="submit($event,this)" action="<?php echo e(route('user.register')); ?>">
								    <?php echo csrf_field(); ?>
									<div class="fieldset">
                                    ...
                                    <div class="fieldset">
                                        <select name="dialing" class="form-control" id="" @change="countrychange($event)" required Placeholder="Select Country">
                                            ...
                                            <option value="<?php echo e($country->dialing); ?>" data-dialing="<?php echo e($country->dialing); ?>"><?php echo e($country->country_name); ?></option>
              ...
              <div class="modal-content">
                 <div class="modal-body">
                    ...
                    <div class="login-box">
                       ...
                       <div class="loginform-wraper">
                          <form method="post" action="<?php echo e(route('front.forgot')); ?>"  class="" id="formforget">
                              <?php echo csrf_field(); ?>
                             <div class="fieldset">
    ...
    var app = new Vue({
        ...
        watch : {
            OTP : function(data){
                if(data.length >= 6){
                    this.Checking = true
                    axios.get(`<?php echo e(route('Otpverify')); ?>?otp=${app.OTP}`)
            ...
            email : function(data){
                axios.get(`<?php echo e(route('checkemail')); ?>?email=${data}`)
                .then(function (response) {
                    if(response.data.status){
                        app.showvalise = true
                    }else{
            ...
            Phone : function(data){
                axios.get(`<?php echo e(route('checkphone')); ?>?phone=${data}`)
                .then(function (response) {
                    if(response.data.status){
        ...
        methods : {
            ...
            generateOTP(){
                ...
                axios.post(`<?php echo e(route('generateOTP')); ?>?phone=${mobile}&_token=<?php echo e(csrf_token()); ?>`)
                .then(function (response) {
                    if(response.data.status){
                        app.start();
                        app.tryagain = true
...
<?php echo $__env->make('front.includes.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/front/login.blade.php ENDPATH**/ ?>