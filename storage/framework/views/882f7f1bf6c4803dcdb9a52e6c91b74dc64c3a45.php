                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <!--end::Page Title-->
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-attributegroup')); ?>" class="text-muted">List of Attribute Groups</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-attributegroup-store')); ?>" enctype="multipart/form-data" id="formCreate" onsubmit="CKEditor5.updateSourceElement();">
...
ClassicEditor.create( document.querySelector( '#kt-ckeditor' ) )
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/attributegroup/create.blade.php ENDPATH**/ ?>