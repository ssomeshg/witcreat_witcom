                                ...
                                <div class="card card-custom gutter-b">
                                    <div class="card-header flex-wrap py-3">
                                        <div class="card-title">
                                            <h3 class="card-label">List of Coupon</h3>
                                        </div>
                                        <div class="card-toolbar">

                                            <!--begin::Button-->
                                            <a href="<?php echo e(route('admin-coupon-create')); ?>" class="btn btn-primary font-weight-bolder">
     ...
     <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               columns: [
                        ...
                        { data: 'OrderValue', name: 'OrderValue' },
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/coupon/index.blade.php ENDPATH**/ ?>