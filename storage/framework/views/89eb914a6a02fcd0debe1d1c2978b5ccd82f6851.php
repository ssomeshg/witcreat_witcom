                                ...
                                <div class="card card-custom gutter-b">
                                    <div class="card-header flex-wrap py-3">
                                        <div class="card-title">
                                            <h3 class="card-label">List of Permissions</h3>
                                        </div>
 ...
 <?php $__env->startPush('script'); ?>                  
     <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               processing: false,
               serverSide: true,
               ajax: "<?php echo e(route('admin-permission-datatables')); ?>",
               columns: [
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/permission/index.blade.php ENDPATH**/ ?>