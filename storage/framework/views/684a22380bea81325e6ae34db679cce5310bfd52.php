              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  profile-leftinner">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cartitem-lits orderlist-wraper">
                    ...
                    <div  id="wishlisttemplate">
                        <?php echo $__env->make('front.includes.wishlistTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopad bottombtn-wraper text-right">
                        
                            <a class="transparent-btn"  href="<?php echo e(route('front.getCategory')); ?>">continue shopping</a>
    ...
    $('body').on('click','.wishlistremove',function(e){
        ...
        $.ajax({
                ...
                success:function(data){ 
                    $('#wishlisttemplate').load('<?php echo e(route('wishlistTemplate')); ?>');
                },
...
<?php echo $__env->make('front.includes.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/front/wishlist.blade.php ENDPATH**/ ?>