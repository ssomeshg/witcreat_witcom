...
<?php $__env->startSection('content'); ?>  
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <!--end::Page Title-->
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-category')); ?>" class="text-muted">List of Category</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-category-store')); ?>" enctype="multipart/form-data" id="formCreate">
                                                ...
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="text" value="<?php echo e(old('category_name')); ?>" id="category_name" name="category_name" required/>
                                                        </div>
                                                    </div>    
                                                    <div class="form-group row">
                                                         ...
                                                         <select class="form-control" id="parent_category_id" name="parent_category_id" >
                                                            ...
                                                            <option value="<?php echo e($category->id); ?>" <?php echo e((old('parent_category_id')==$category->id)?'selected':''); ?>><?php echo e($category->category_name); ?></option>
                                                            ...
                                                            <option value="<?php echo e($subCategory->id); ?>" <?php echo e((old('parent_category_id')==$subCategory->id)?'selected':''); ?>>--<?php echo e($subCategory->category_name); ?></option>
                                                    ...
                                                    <div class="form-group row">
                                                         ...
                                                         <span class="text-danger">*</span></label>
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('Category_url')); ?>" id="Category_url" name="Category_url" required/>
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <span class="text-danger">*</span></label>
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('hns_code')); ?>" id="hns_code" name="hns_code" />
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <span class="text-danger"></span></label>
                                                         <div class="col-10">
                                                            <textarea name="short_description" id="kt-ckeditor-4"><?php echo e(old('short_description')); ?></textarea>
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-3">
                                             <label for="style_1">
                                                <img style="width:255px;border:2px dashed #222;height: 325px;" src="" id="image1">
                                                </label>
                                            <input style="display: none" type="file"  accept="image/*" onchange="loadFile(event)" id="style_1" name="style_1" >
                                            
                                        <span class="text-danger">Width:220px and Height:325px</span>
                                        </div>
                                     </div>         
                                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <span class="text-danger">Width:600px and Height:600px</span>
                                                    ...
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('meta_title')); ?>" id="meta_title" name="meta_title" />
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('meta_description')); ?>" id="meta_description" name="meta_description" />
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('meta_keywords')); ?>" id="meta_keywords" name="meta_keywords" />
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('sort_order')); ?>" id="sort_order" name="sort_order" />
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                            <label class="checkbox checkbox-success">
                                                                <input type="checkbox" name="featured_category" value=1 <?php echo e((old('featured_category')==1) ? ' checked' : ''); ?>/>
                                                                <span></span>
                                                            </label>
                                                         </div>
                                                     </div>            
                                                    <div class="form-group row">
                                                         ...
                                                         <div class="col-10">
                                                            <label class="checkbox checkbox-success">
                                                                <input type="checkbox" name="featured_collection" value=1 <?php echo e((old('featured_collection')==1) ? ' checked' : ''); ?>/>
                                                                <span></span>
                                                            </label>
                                                         </div>
                                                     </div>            
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\witcreat_witcom\resources\views/admin/category/create.blade.php ENDPATH**/ ?>