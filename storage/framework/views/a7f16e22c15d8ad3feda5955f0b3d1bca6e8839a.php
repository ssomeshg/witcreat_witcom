                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <!--end::Page Title-->
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-homeslider')); ?>" class="text-muted">List of Home Page Products</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-homeslider-store')); ?>" onsubmit="return validation()" id="formCreate">
...
<script>
    ...
    $("#choices-multiple-remove-button").on('change',function(){
        $.post('<?php echo e(route('admin-homeslider-load')); ?>',{"_token": "<?php echo e(csrf_token()); ?>",data:$(this).val()},function(data,status){
            $('#table').html(data);
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\witcreat_witcom\resources\views/admin/homepageslider/create.blade.php ENDPATH**/ ?>