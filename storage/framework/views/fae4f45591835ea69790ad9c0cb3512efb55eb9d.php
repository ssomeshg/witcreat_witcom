                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card card-custom">
                            <!--begin::Form-->
                            <form method="POST" action="<?php echo e(route('admin-report-get')); ?>">
                                <div class="card-body">
...
<?php $__env->startPush('script'); ?>                  
     ...
     function loadtable(){
        var table = $('#geniustable').DataTable({
               ...
               ajax: {
                   ...
                   type : 'POST',
                   data : { FromDate : $("#FromDate").val(),ToDate : $("#ToDate").val(),_token: '<?php echo e(csrf_token()); ?>'}
               },
               dom: 'Bfrtip',
               searching: false,
               buttons: ['copy', 'csv', 'excel'],
 ...
 <?php $__env->stopPush(); ?>   
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/sales/salesReport.blade.php ENDPATH**/ ?>