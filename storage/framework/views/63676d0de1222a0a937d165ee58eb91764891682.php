                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" style="display:none" role="alert">
                                            ...
                                            ?>
                        <form method="POST" action="<?php echo e($link); ?>" enctype="multipart/form-data" id="formCreate" onsubmit="if(typeof CKEditor1 != 'undefined'){ CKEditor1.updateSourceElement(); } if(typeof CKEditor3 != 'undefined'){ CKEditor3.updateSourceElement(); } CKEditor2.updateSourceElement();">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" id="id" value=0>
                            <input type="hidden" id="url" name="url" value="<?php echo e($url); ?>">
                            <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" id="vendor" name="vendor" >
                                        ...
                                        <?php $__currentLoopData = $vendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                                            <option data-productPrefix="<?php echo e($v->manufacturerID); ?>" data-vendorperscent="<?php echo e($v->vendorperscent); ?>" value="<?php echo e($v->id); ?>"><?php echo e($v->name.' / '.$StoreConfig->VendorIDPrefix.'-'.sprintf("%'03d", $v->id)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <?php else: ?>
                            <input type="hidden" name="vendor" value="<?php echo e(Auth::user()->is_vendor); ?>">
                            <?php endif; ?>
                               <div class="form-group row">
                                    ...
                                    <select class="form-control" id="category" name="category[]" multiple>
                                        ...
                                        <option  value="<?php echo e($category->id); ?>"><?php echo e($category->category_name); ?></option>
                                            <?php $__currentLoopData = $category->subs()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sub->id); ?>"><?php echo e($sub->category_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <input class="form-control" type="text" value="<?php echo e(old('productTitle')); ?>" id="productTitle" name="productTitle" />
                                </div>
                            </div>
                            <?php if(Auth::user()->is_vendor == null): ?>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-3">
                                    <select name="markup_type" class="form-control" id="markup_type">
                                        <option value="0" <?php echo e((old('markup_type') == 0) ? 'selected' : ''); ?>>%</option>
                                        <option value="1" <?php echo e((old('markup_type') == 1) ? 'selected' : ''); ?>>Flat</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <input class="form-control" type="text" value="<?php echo e(old('basePrice')); ?>" id="basePrice" name="basePrice" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="Code"><?php echo e($persenttest->productPrefix); ?></span>
                                        </div>
                                        <input class="form-control" type="text" value="" id="manufacturerCode" name="manufacturerCode" />
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <input class="form-control" type="text" value="<?php echo e(old('basePrice')); ?>" id="basePrice" name="basePrice" readonly/>
                                    <input class="form-control" type="hidden" value="<?php echo e($attributeTemplate); ?>" id="attributeTemplate" name="attributeTemplate" />
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <span>This is Silkastic Price, No need to Enter</span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12 col-lg-5">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php echo e(old('skuCode')); ?>" id="skuCode" name="skuCode" />
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Last SKU Code <?php echo e($StoreConfig->productIdprefix); ?><?php echo e(isset($Product_last->product_sku)?$Product_last->product_sku:"not found"); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                            ...
                            <?php $__currentLoopData = $processGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $processGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!empty($processGroup[0])): ?>
                            <?php switch($processGroup[0]->attribute_type):
                            case (1): ?>
                            <div class="form-group row">
                                <label class="col-md-12 col-lg-2 col-form-label"><?php echo e($processGroup[0]->attribute_name); ?></label>
                                <div class="col-lg-4 col-md-12">
                                    <input class="form-control" type="text" value="<?php echo e(old('attributes[$processGroup[0]->attribute_name]')); ?>" id="<?php echo e($processGroup[0]->attribute_name); ?>" name="attributes[<?php echo e($processGroup[0]->id); ?>]" />
                                </div>
                            </div>
                            <?php break; ?>
                            <?php case (2): ?>
                            <div class="form-group row">
                                <label class="col-md-12 col-lg-2 col-form-label"><?php echo e($processGroup[0]->attribute_name); ?></label>
                                <div class="col-lg-10 col-md-12">
                                    <textarea name="attributes[<?php echo e($processGroup[0]->id); ?>]" id="ktckeditor3"><?php echo e(old('attributes[$processGroup[0]->attribute_name]')); ?></textarea>
                            ...
                            <div class="form-group row">
                                <label class="col-md-12 col-lg-2 col-form-label"><?php echo e($processGroup[0]->attribute_name); ?></label>
                                <div class="col-lg-10 col-md-12">
                                  <select class="form-control multis" id="<?php echo e($processGroup[0]->attribute_name); ?>" name="attributes[<?php echo e($processGroup[0]->id); ?>]" >
                                      ...
                                      ?>
                                      <option value="<?php echo e($attributeValues1); ?>" <?php echo e((in_array($attributeValues1,explode(',',old('attributes[$processGroup[0]->attribute_name]')))?'selected':'')); ?>><?php echo e($attributeValues1); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      <?php endif; ?>
                                  </select>
                              </div>
                          ...
                          <?php break; ?>
                            ...
                            <div class="form-group row">
                                <label class="col-md-12 col-lg-2 col-form-label"><?php echo e($processGroup[0]->attribute_name); ?></label>
                                <div class="col-lg-10 col-md-12">
                                  <select class="form-control multis" id="<?php echo e($processGroup[0]->attribute_name); ?>" name="attributes[<?php echo e($processGroup[0]->id); ?>][]" multiple>
                                      <?php if($attributeValues>0): ?>
                                      <?php $__currentLoopData = $attributeValues1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeValues1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php
                                      if(old('attributes[$processGroup[0]->attribute_name][]')){
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-12 col-form-label">
                                <div class="form-check pl-0 checkbox-inline">
                                    ...
                                    <label class="checkbox checkbox-outline">
                                        <input type="checkbox" name="attributes[<?php echo e($processGroup[0]->id); ?>][]" value="<?php echo e($attributeValues1); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-12 col-form-label">
                                    <div class="form-check pl-0 checkbox-inline">
                                        ...
                                        <?php $__currentLoopData = $attributeValues1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeValues1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="checkbox checkbox-outline">
                                            <input type="radio" name="attributes[<?php echo e($processGroup[0]->id); ?>][]" value="<?php echo e($attributeValues1); ?>">
                                            <span></span><?php echo e($attributeValues1); ?></label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="input-group">
                                            <select class="form-control" id="tax" name="tax"  required>
                                                ...
                                                <option data-tax_type=<?php echo e($tax->tax_type); ?> data-tax_rate=<?php echo e($tax->tax_rate); ?> value="<?php echo e($tax->id); ?>" <?php echo e((old('tax') == $tax->id) ? 'selected' : ''); ?>><?php echo e($tax->tax_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-9">
                                    <input type="text" name="weight" value="<?php echo e(old('weight')); ?>" class="form-control" required>
                                </div>
                                <div class="col-lg-2 col-md-3">
                                    <select name="weightUnit" class="form-control" >
                                        <option value="1" <?php echo e((old('weightUnit') == 1) ? 'selected' : ''); ?>>Gram</option>
                                        <option value="2" <?php echo e((old('weightUnit') == 2) ? 'selected' : ''); ?>>KG</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10 col-md-12">
                                    <textarea name="productDescription" id="ktckeditor2"><?php echo e(old('productDescription')); ?></textarea>
                                    <div class="fv-plugins-message-container"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <input data-switch="true" type="checkbox" checked="checked" name="trending" data-on-color="success" data-off-color="danger" name="trending" <?php echo e((old('trending') == 'on') ? 'checked' : ''); ?> />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10 col-md-12">
                                    <textarea name="metadescription" id="ktckeditor1"><?php echo e(old('metadescription')); ?></textarea>
                                    <div class="fv-plugins-message-container"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <input data-switch="true" type="checkbox"  data-on-color="success" data-off-color="danger" name="soldout" value="on" <?php echo e((old('soldout') == 'on') ? 'checked' : ''); ?> />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <select name="similarProducts[]" id="similarProducts" class="form-control" multiple="multiple">
                                        ...
                                        <option value="<?php echo e($similarProduct->id); ?>" <?php echo e((old('similarProducts') == $similarProduct->id) ? 'selected' : ''); ?>><?php echo e($similarProduct->product_title); ?>/SKU: <?php echo e($StoreConfig->productIdprefix); ?><?php echo e($similarProduct->product_sku); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <select name="relatedProducts[]" id="relatedProducts" class="form-control" multiple="multiple">
                                        ...
                                        <option value="<?php echo e($relatedProduct->id); ?>" <?php echo e((old('relatedProducts') == $relatedProduct->id) ? 'selected' : ''); ?>><?php echo e($relatedProduct->product_title); ?>/SKU: <?php echo e($StoreConfig->productIdprefix); ?><?php echo e($relatedProduct->product_sku); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/product/create.blade.php ENDPATH**/ ?>