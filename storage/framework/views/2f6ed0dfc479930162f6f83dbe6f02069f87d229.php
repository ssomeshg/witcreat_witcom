                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <!--end::Page Title-->
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-blog')); ?>" class="text-muted">List of Blog</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-blog-store')); ?>" enctype="multipart/form-data" id="formCreate">
                                                ...
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="text" value="<?php echo e(old('blog_url')); ?>" id="blog_url" name="blog_url" required/>
                                                        </div>
                                                    </div>    
                                                    <div class="form-group row">
                                ...
                                <div class="col-3">
                                    ...
                                    <span class="form-text text-muted">Image width and height:250*310</span>
                                                    ...
                                                    <div class="form-group row"  id="video_ids">
                                                         ...
                                                         <span class="text-danger">*</span></label>
                                                         <div class="col-10">
                                                             <input class="form-control" type="text" value="<?php echo e(old('blog_video')); ?>" id="blog_video" name="blog_video"  />
                                                         </div>
                                                     </div>   
                                                    <div class="form-group row">
                                                         ...
                                                         <span class="text-danger">*</span></label>
                                                         <div class="col-10">
                                                            <textarea name="blog_content" id="kt-ckeditor-4" ><?php echo e(old('blog_content')); ?></textarea>
                                ...
                                <label class="col-2 col-form-label">Home Flag</label>
                                    ...
                                    <input data-switch="true" type="checkbox" checked="checked" data-on-color="success" data-off-color="danger" name="home_flag" value="1" <?php echo e((old('home_flag') == '1') ? 'checked' : ''); ?> />
                                </div>
                            </div>
...
jQuery(document).ready(function() {
          ...
          $('.crop_image').click(function(event){
            ...
            $image_crop.croppie('result', {
              ...
              size: 'viewport'
                ...
                $.ajax({
                    url:"<?php echo e(route('admin-blog-cropimage')); ?>",
                    type: "POST",
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\witcreat_witcom\resources\views/admin/blog/create.blade.php ENDPATH**/ ?>