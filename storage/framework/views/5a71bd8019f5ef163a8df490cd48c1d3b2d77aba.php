...
<div class="modal fade" id="exampleModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
 ...
 <?php $__env->startPush('script'); ?>                  
     ...
     var URL = '<?php echo e(route('baseurl')); ?>';
...
var initTable1 = function() {
    ...
    var table = $('#kt_datatable1').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route('admin-order-datatables')); ?>',
            type: 'POST',
            data: {
        ...
        columnDefs: [{
                ...
                render: function(data, type, full, meta) {
                    var URL_View= '<?php echo e(route('admin-order-view1')); ?>/'+data;
                    return '\
							<div class="dropdown dropdown-inline">\
            ...
            },
            {
                ...
                width: '100px',
                render:function(data, type, full, meta){
                    return '<?php echo e($StoreConfig->OrderIDPrefix); ?>'+full.id;
                }
            },
            {
                targets: 6,
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/order/index.blade.php ENDPATH**/ ?>