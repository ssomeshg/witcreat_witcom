...
var KTDatatablesSearchOptionsAdvancedSearch1 = function() {
    ...
    var initTable11 = function() {
        ...
        var table = $('#kt_datatable1').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(route('admin-customer-datatables')); ?>',
                type: 'POST',
                data: {
            ...
            },
            {
                ...
                render:function(data, type, full, meta){
                    return '<?php echo e($StoreConfig->CustomerIDPrefix); ?>'+(full.id).toString().padStart(3,0);
                }
            },
            {
                targets: 10,
                ...
                width: '100px',
                render: function(data, type, full, meta) {
                    var baseURL = '<?php echo e(route('admin-baseURL-customer-status')); ?>';
                    var option = "";
                        var status = {
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function(data, type, full, meta) {
                        var baseURL = '<?php echo e(route('admin-customer-edit')); ?>/'+full.id;
                        var deleteurl = '<?php echo e(route('admin-customer-delete')); ?>/'+full.id;
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/customer/index.blade.php ENDPATH**/ ?>