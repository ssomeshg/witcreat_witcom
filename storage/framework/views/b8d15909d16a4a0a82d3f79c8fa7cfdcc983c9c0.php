...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo e(URL::asset('assets/css/pages/login/login-1.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin">
                                ...
                                <a href="<?php echo e(route('front.index')); ?>">
                                    <img src="<?php echo e(asset('assets/media/banner/'.$StoreConfig->logo)); ?>" alt="Logo" style="width: 150px;height: 100px;display: block;margin-left: auto;margin-right: auto;"/>
                                </a>
							...
							<form class="form" action="<?php echo e(route('admin.login.submit')); ?>" method="POST">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="username" value="<?php echo e(old('username')); ?>" autocomplete="off" required/>
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" name="password"  value="<?php echo e(old('password')); ?>" autocomplete="off" required/>
								</div>
								<!--end::Form group-->
								<!--begin::Action-->
						...
						<div class="login-form login-forgot">
							<!--begin::Form-->
							<form class="form" method="post" action="<?php echo e(route('admin-forgot')); ?>">
								<?php echo e(csrf_field()); ?>
		...
		<!-- <script src="<?php echo e(URL::asset('assets/js/pages/custom/login/login-general.js')); ?>"></script> -->
		<!--end::Page Scripts-->
		<script >
	...
	<!--end::Body-->
</html><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/login.blade.php ENDPATH**/ ?>