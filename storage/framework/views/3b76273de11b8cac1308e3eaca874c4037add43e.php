...
<?php $__env->startSection('content'); ?>  
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <!--end::Page Title-->
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-banner')); ?>" class="text-muted">List of Banners</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-banner-update',$data->id)); ?>" enctype="multipart/form-data" id="formEdit">
                                                ...
                                                <div class="card-body">
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="<?php echo e($data->banner_name); ?>" id="bannerName" name="bannerName" />
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <option value="1" <?php echo e($data->position == 1 ? 'selected' :''); ?>>Main Banner</option>
                                                        </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" id="app">
                                                        ...
                                                        <div class="col-10">
                                                            <label for="bannerImage">
                                                                <img src="<?php echo e(URL::asset('assets/media/banner/'.$data->web_image)); ?>" style="width:640px;border:2px dashed #222;height: 295px" id="image1">
                                                            </label>
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                             <label for="mobileImage">
                                                                <img src="<?php echo e(URL::asset('assets/media/banner/'.$data->mobile_image)); ?>" style="width:640px;border:2px dashed #222;height: 295px" id="image2">
                                                            </label>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="<?php echo e($data->banner_title); ?>" id="banner_title" name="bannerTitle" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="<?php echo e($data->banner_link); ?>" id="bannerLink" name="bannerLink" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-4">
                                                            <input class="form-control" type="number" value="<?php echo e($data->sorting_order); ?>" id="sortOrder" name="sortOrder" />
                                                        </div>
                                                    </div>
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\witcreat_witcom\resources\views/admin/banner/edit.blade.php ENDPATH**/ ?>