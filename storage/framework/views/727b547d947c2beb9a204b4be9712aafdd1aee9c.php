...
<?php $__env->startSection('content'); ?>  
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-vendor')); ?>" class="text-muted">List of Vendor</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-vendor-update',$data->id)); ?>" id="formEdit" onsubmit="CKEditor1.updateSourceElement();">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <select class="form-control" id="type" name="type" required onchange="typechange(this.value)">
                                                            <option value="Company" <?php echo e(($data->type === 'Company')?'selected':''); ?>>Company</option>
                                                            <option value="Individual" <?php echo e(($data->type === 'Individual')?'selected':''); ?>>Individual</option>
                                                        </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text"  id="name" name="name" required value="<?php echo e($data->name); ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-3">
                                                            <input class="form-control" type="text" id="manufacturerID" maxlength="5" value="<?php echo e($data->manufacturerID); ?>" name="manufacturerID" required/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-3">
                                                        <select class="form-control form-control-solid form-control-lg country" id="billingCountry" name="billingCountry" required>
                                                           <option disabled selected>Select Country</option>
                                                            ...
                                                            <option value="<?php echo e($countries->id); ?>" <?php echo e(($data->billingCountry == $countries->id )?'selected':''); ?>><?php echo e($countries->country_name); ?></option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <div class="col-3">
                                                        <select class="form-control states form-control-solid form-control-lg" id="billingState" name="billingState" required>
                                                           <option disabled selected>Select State</option>
                                                            <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $states): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                               <option value="<?php echo e($states->id); ?>" <?php echo e(($data->billingState == $states->id )?'selected':''); ?>><?php echo e($states->state_name); ?></option>
                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <div class="col-3">
                                                        <select class="form-control form-control-solid city form-control-lg" id="billingCity" name="billingCity" required>
                                                           <option disabled selected>Select City</option>
                                                            <?php $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cities): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                               <option value="<?php echo e($cities->id); ?>" <?php echo e(($data->billingCity == $cities->id )?'selected':''); ?>><?php echo e($cities->city_name); ?></option>
                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <span class="text-danger">*</span></label>
                                                            <div class="col-3">
                                                        <select class="form-control pincode form-control-solid form-control-lg" id="pincode" name="pincode" required>
                                                           <option disabled selected>select Pincode</option>
                                                            <?php $__currentLoopData = $pincode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pincodes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($pincodes->id); ?>"  <?php echo e(($data->pincode == $pincodes->id )?'selected':''); ?>><?php echo e($pincodes->pincode); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger"></span></label>
                                                        <div class="col-10">
                                                           <textarea name="address" id="ktckeditor1"><?php echo e($data->address); ?></textarea>
                                                           <div class="fv-plugins-message-container"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row " id="require" style="<?php echo e(($data->type === 'Company')?'':'display:none'); ?>">
                                                        <label class="col-2 col-form-label " >GST NO
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="<?php echo e($data->gstNo); ?>" id="gstNo" name="gstNo" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row" id="require">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-2">
                                                            <input class="form-control" type="text" value="<?php echo e($data->vendorperscent); ?>" id="vendorperscent" name="vendorperscent" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="email" value="<?php echo e($data->email); ?>" id="email" name="email" placeholder="example@email.com", pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Invalid email address"  required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="<?php echo e($data->contact); ?>" id="contact" name="contact" pattern="[0-9]+" title="Number Only Accept" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                        <div class="col-4">
                                                            <input class="form-control" type="text" value="<?php echo e($data->username); ?>" id="username" name="username" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <select class="form-control" id="role_id" name="role_id" required>
                                                           ...
                                                           <?php $__currentLoopData = $Role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $C): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($C->id); ?>" <?php echo e(($data->role_id == $C->id )?'selected':''); ?>><?php echo e($C->role_name); ?></option>
                                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                        </div>
                                                    </div>
 ...
 <script>
    ...
    function loadstste(data){
        if(data != "" && data != null){
            $.get('<?php echo e(route('admin-vendor-getTemplate')); ?>',{id:data}, function(data, status){
                $("#template").html(data);
            });
        }else{
            $("#template").html("");
...
$('#billingCountry').select2({placeholder:'Select Country'}).on('select2:close', function(){
    ...
    {
      $.ajax({
        url:"<?php echo e(route('admin-getstate-user')); ?>",
        method:"POST",
    ...
    {
      $.ajax({
        url:"<?php echo e(route('admin-getCities-user')); ?>",
        method:"POST",
  ...
  $('#billingCity').select2({tags:true,placeholder:'Select City'}).on('select2:close', function(){
    ...
    {
      $.ajax({
        url:"<?php echo e(route('admin-getPincodes-user')); ?>",
        method:"POST",
...
$('#pincode').select2({tags:true,placeholder:'Select Pincode'}).on('select2:close', function(){
   ...
   var country = $('#billingCountry').val();
    ...
    {
      $.ajax({
        url:"<?php echo e(route('admin-addPincodes-user')); ?>",
        method:"POST",
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/vendor/edit.blade.php ENDPATH**/ ?>