...
<script>
    var min = parseInt('<?php echo e($min); ?>');
    var max = parseInt('<?php echo e($max); ?>') +1;
                                        ...
                                        <div aria-expanded="false" class="collapse" id="collapseMenu1" style="">
                                            <div class="well">
                                                <ul class="collapse-submenu">
                                                    <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(count($categorys->subs) >0): ?>
                                                    <li>
			<a href="<?php echo e(route('front.filter',[$categorys->id])); ?>"  data-id="<?php echo e($categorys->id); ?>" class="Category"><?php echo e($categorys->category_name); ?></a> 
			<a aria-controls="collapseMenu1" aria-expanded="false"  data-toggle="collapse" href="#collapseMenu1<?php echo e($categorys->id); ?>" id="flexible-packaging" role="button"><i class="fa fa-minus" aria-hidden="true"></i></a>
			<div aria-expanded="false" class="collapse in" id="collapseMenu1<?php echo e($categorys->id); ?>" style="">
				<div class="well">
					<ul class="collapse-submenu">
					    <?php $__currentLoopData = $categorys->subs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li>
						<a href="<?php echo e(route('front.filter',[$subCates->id])); ?>" data-id="<?php echo e($subCates->id); ?>" class="Category"><?php echo e($subCates->category_name); ?></a> 
					</li>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="filtermain-wraper">
                                <ul class="collapsemenu">
                                    <?php $i = 0 ;?>
                                    <?php $__currentLoopData = $attributeValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeValues): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(count(explode(',',$attributeValues->attribute_values)) > 0): ?>
                                    <?php $i++;?>
                                    <li>
                                        ...
                                        <div aria-expanded="false" class="collapse" id="delivery-availability<?php echo e($i); ?>" style="">
                                            <div class="well">
                                                <div class="filterlist">
                                                    <?php $__currentLoopData = explode(',',$attributeValues->attribute_values); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div>
                                                        <input type="checkbox" data-id="<?php echo e($attributeValues->id); ?>-<?php echo e($values); ?>" onclick="" name="attr[]" id="<?php echo e($attributeValues->id); ?>-<?php echo e($values); ?>" value="<?php echo e($attributeValues->id); ?>">
                                                        <label for="<?php echo e($attributeValues->id); ?>-<?php echo e($values); ?>"><?php echo e($values); ?></label>
                                                    </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            </div>
                ...
                <section class="cd-gallery col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div id="renderproduct">
                        <?php echo $__env->make('front.product-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
...
var self = $('.filter-price-slider')[0];
    noUiSlider.create( self, $.extend( true, {
                    start: [ <?php echo e((isset($_GET['min']))?(int)$_GET['min']:(int)$min); ?>,<?php echo e((isset($_GET['max']))?(int)$_GET['max']:(int)$max + 1); ?> ],
                    connect: true,
                    step: 1,
                    range: {
                        min: min,
        ...
        var cat = '<?php echo e(!empty($cat)?$cat->id:null); ?>';
        var subcat ='<?php echo e(!empty($subcat)?$subcat->id:null); ?>';
        var max1 = max;
        var min1 = min;
        var sort = null;
        var attribute = [];
        ...
        function filter() {
            var selectfilter ='';
            var url = '<?php echo e(route('front.filter')); ?>';
            if(cat != null){
                url += '/'+cat;
                if(subcat != null){
                    url += '/'+subcat;
...
<?php echo $__env->make('front.includes.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/front/shop.blade.php ENDPATH**/ ?>