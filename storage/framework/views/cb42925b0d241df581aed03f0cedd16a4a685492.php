...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="flex-column-fluid">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4">
                                            <select class="form-control avoide" id="vendor" name="vendor">
                                                ...
                                                <option data-productPrefix="<?php echo e($v->manufacturerID); ?>"
                                                    data-vendorperscent="<?php echo e($v->vendorperscent); ?>" value="<?php echo e($v->id); ?>">
                                                    <?php echo e($v->name.' / '.$StoreConfig->VendorIDPrefix.'-'.sprintf("%'03d", $v->id)); ?>
        ...
        <div class="container" id="app1" v-if="isHidden">
            <!--begin::Card-->
            <form action="<?php echo e(route('admin-submitpay')); ?>" method="POST" @submit="SubmitPay" >
                <?php echo csrf_field(); ?>
                    ...
                    <div class="card card-custom" v-if=datapresent>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <input class="form-control" type="date" name="PaymentDate" value="<?php echo e(date('Y-m-d')); ?>"  id="PaymentDate" />
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            const formData = new FormData(e.target);
                ...
                setTimeout(function(){
                    $('#geniustable1').DataTable({
                        ...
                        scrollX: true,
                        ajax: {
                            url : "<?php echo e(route('admin-paydatatable')); ?>",
                            type : 'GET',
    ...
    var app1 = new Vue({
        ...
        methods: {
            ...
            SubmitPay(e){
                ...
                $.ajax({
                    method:"POST",
                    url:'<?php echo e(route('admin-submitpay')); ?>',
                    data:formData,
                    cache: false,
                    processData: false,
                    contentType: false,
    ...
    var app2 = new Vue({
        ...
        methods :{
            ...
            SubmitPay(e){
                ...
                $.ajax({
                    method:"POST",
                    url:'<?php echo e(route('admin-editsubmitpay')); ?>',
                    data:formData,
                    cache: false,
                    processData: false,
                    contentType: false,
  ...
  function formsubmit(e,t){
    ...
    <script type="text/javascript">
            var table = $('#geniustable').DataTable({
               ...
               scrollX: true,
               ajax: {
                   url : "<?php echo e(route('admin-VendorPayment-get')); ?>",
                   type : 'GET',
               },
               dom: 'Bfrtip',
               searching: false,
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/vendorPay/index.blade.php ENDPATH**/ ?>