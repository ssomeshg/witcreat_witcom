...
<?php $__env->startSection('content'); ?>  
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <!--end::Page Title-->
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('admin-attribute')); ?>" class="text-muted">List of Attributes</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--end::Page Heading-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-attribute-store')); ?>" enctype="multipart/form-data" id="formCreate">
                                                   ...
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            ...
                                                            <option value="<?php echo e($data->id); ?>"><?php echo e($data->attribute_type); ?></option>
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/attribute/create.blade.php ENDPATH**/ ?>