                                ...
                                <div class="card card-custom gutter-b">
                                    <div class="card-header flex-wrap py-3">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <!--begin::Button-->
                                            <a href="<?php echo e(route('admin-homecat-create')); ?>" class="btn btn-primary font-weight-bolder">
 ...
 <?php $__env->startPush('script'); ?>                  
     <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               processing: false,
               serverSide: true,
               ajax: "<?php echo e(route('admin-homecat-datatables')); ?>",
               columns: [
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\witcreat_witcom\resources\views/admin/homecat/index.blade.php ENDPATH**/ ?>