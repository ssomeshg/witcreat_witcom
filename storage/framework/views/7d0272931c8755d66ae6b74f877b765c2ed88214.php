         ...
         <div class="menu-wraper">
               ...
               <div class="row flex-center">
                     ...
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        ...
                        <a class="navbar-brand" href="<?php echo e(route('front.index')); ?>">
                           <img src="<?php echo e(URL::asset('assets/media/banner/'.$StoreConfig->logo)); ?>" class="img-responsive logo-image" alt="logo">
                        </a>
						</div>
			...
			<h3>Menu</h3>
				...
				<ul class="nav navbar-nav">
                              ...
                              <form action="<?php echo e(route('front.getCategory',[Request::route('category'),Request::route('sub')])); ?>" method="get" id="search">
                                 <div class="topsearch">
                                    <div class="input-group">
                                       ...
                                       <button class="btn btn-default" onclick="myfunction($('#search').attr('action'),$('#textsearch').val())" type="button"><i class="fa fa-search"></i></button>
                                       </span>
                                    </div>
                                    <!-- /input-group -->
                                 </div>
                     ...
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 mobrht">
...
<?php /**PATH C:\xampp\htdocs\wetransfer_witcreat_witecom\resources\views/front/includes/header.blade.php ENDPATH**/ ?>