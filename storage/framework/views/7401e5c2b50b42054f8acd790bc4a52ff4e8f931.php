        ...
        <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 orderlist-wraper">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cartmobtitle deskhide">
                                    <a href="<?php echo e((Auth::user()?route('view.cart'):route('front.loginBlade'))); ?>" class="mobback"><span class="fa fa-arrow-left"></span></a>
                                    <h3><span>My Addresses</span></h3>
                                </div>
                                <div class="addresslist-container">
                                    <div id="userAddress">
                                        <?php echo $__env->make('front.includes.userAddress', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 profile-rightwraper mobpricedet">
                <div class="profileright-inner" id="cart_summery">
                    <?php echo $__env->make('front.includes.cart_summery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('body').on('click', '.Delete-link', function (e) {
        ...
        $.get($(this).attr('href'), function (data) {
            $('#userAddress').load("<?php echo e(route('user.render.address')); ?>", function () {
                ...
                if($('body input[name="shipping"]:checked').length == 0){
                    $.ajax({
                        ...
                        method: "POST",
                        url: '<?php echo e(route('cart_summer')); ?>',
                        data: {
                            id: 0,
    ...
    $('#form12').submit(function (e) {
        ...
        $.ajax({
            method: "POST",
            url: '<?php echo e(route('user.add.address')); ?>',
...
<?php echo $__env->make('front.includes.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/front/deliveryaddress.blade.php ENDPATH**/ ?>