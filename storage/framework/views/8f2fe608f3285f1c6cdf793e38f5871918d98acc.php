                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="<?php echo e(route('admin-store')); ?>" class="text-muted">List of store</a>
                        </li>
                    </ul>
                </div>
                <!--end::Page Heading-->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <form method="POST" action="<?php echo e(route('admin-store-update',$data->id)); ?>" id="formEdit" enctype="multipart/form-data" onsubmit="CKEditor1.updateSourceElement();CKEditor2.updateSourceElement();CKEditor3.updateSourceElement();if(typeof CKEditor4 != 'undefined'){ CKEditor4.updateSourceElement(); }CKEditor5.updateSourceElement();CKEditor6.updateSourceElement();">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" type="text" value="<?php echo e($data->store_name); ?>" id="store_name" name="store_name" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <select class="form-control" id="default_currency" name="default_currency">
                                            ...
                                            <option value="<?php echo e($cur->id); ?>" <?php echo e(($cur->id == $data->default_currency)?'selected':''); ?>><?php echo e($cur->currency_symbol); ?> (<?php echo e($cur->currency_title); ?>)</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <select class="form-control" id="ownershiptype" name="ownershiptype">
                                            ...
                                            <option value="Partnership" <?php echo e(($data->ownershiptype == "Partnership")?'selected':''); ?>>Partnership</option>
                                            <option value="Public Sector" <?php echo e(($data->ownershiptype == "Public Sector")?'selected':''); ?>>Public Sector</option>
                                            <option value="Private Sector" <?php echo e(($data->ownershiptype == "Private Sector")?'selected':''); ?>>Private Sector</option>
                                            <option value="Single Ownership" <?php echo e(($data->ownershiptype == "Single Ownership")?'selected':''); ?>>Single Ownership</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <div class="radio-inline">
                                            <label class="radio radio-success">
                                                <input type="radio" name="include_tax"  value='Inclusive' <?php echo e(($data->include_tax === 'Inclusive')? 'checked':''); ?>/>
                                                <span></span>
                                                Inclusive
                                            </label>
                                            <label class="radio radio-success">
                                                <input type="radio" name="include_tax"  value='Exclusive' <?php echo e(($data->include_tax === 'Exclusive')? 'checked':''); ?> />
                                                <span></span>
                                                Exclusive
                                            </label>
                                        </div>
                                    ...
                                    <label class="col-2 col-form-label">Store Date Formate
                                        ...
                                        <div class="col-3">
                                            <select class="form-control" id="default_date_formate" name="default_date_formate" required>
                                                ...
                                                <option value="MM/DD/YY" <?php echo e(($data->default_date_formate === 'MM/DD/YY' )?'selected':''); ?>>MM/DD/YY</option>
                                                <option value="MM-DD-YY" <?php echo e(($data->default_date_formate === 'MM-DD-YY' )?'selected':''); ?>>MM-DD-YY</option>
                                                <option value="DD/MM/YY" <?php echo e(($data->default_date_formate === 'DD/MM/YY' )?'selected':''); ?>>DD/MM/YY</option>
                                                <option value="DD-MM-YY" <?php echo e(($data->default_date_formate === 'DD-MM-YY' )?'selected':''); ?>>DD-MM-YY</option>
                                            </select>
                                        </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Order ID Prefix
                                        <span class="text-danger">*</span></label>
                                    <div class="col-3">
                                        <input class="form-control" type="text" value="<?php echo e($data->OrderIDPrefix); ?>" id="OrderIDPrefix" name="OrderIDPrefix" required maxlength="5" title="Length Must be max 4" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Customer ID Prefix
                                        <span class="text-danger">*</span></label>
                                    <div class="col-3">
                                        <input class="form-control" type="text" value="<?php echo e($data->CustomerIDPrefix); ?>" id="CustomerIDPrefix" name="CustomerIDPrefix" required maxlength="5" title="Length Must be max 4"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Vendor ID Prefix
                                        <span class="text-danger">*</span></label>
                                    <div class="col-3">
                                        <input class="form-control" type="text" value="<?php echo e($data->VendorIDPrefix); ?>" id="VendorIDPrefix" name="VendorIDPrefix" required maxlength="5" title="Length Must be max 4"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Product ID Prefix
                                        <span class="text-danger">*</span></label>
                                    <div class="col-3">
                                        <input class="form-control" type="text" value="<?php echo e($data->productIdprefix); ?>" id="productIdprefix" name="productIdprefix" required maxlength="5" title="Length Must be max 4"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea name="billing_address"
                                            id="ktckeditor6"><?php echo e($data->billing_address); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea name="location_address"
                                            id="ktckeditor5"><?php echo e($data->location_address); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <div class="radio-inline">
                                            <label class="radio radio-success">
                                                <input type="radio" name="out_of_stock"  value='1' <?php echo e(($data->out_of_stock === '1')? 'checked':''); ?>/>
                                                <span></span>
                                                Yes
                                            </label>
                                            <label class="radio radio-success">
                                                <input type="radio" name="out_of_stock"  value='0' <?php echo e(($data->out_of_stock === '0')? 'checked':''); ?> />
                                                <span></span>
                                                NO
                                            </label>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">logo
                                        <span class="text-danger"></span></label>
                                    <div class="col-10">
                                        <label for="logo"><img class="file-preview" style="width:666px;border:2px dashed #222;height: 242px"  src="<?php echo e(URL::asset('assets/media/banner/'.$data->logo)); ?>"></label>
                                        <input type="hidden" name="logo" value="<?php echo e($data->logo); ?>">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Invert Logo
                                        <span class="text-danger"></span></label>
                                    <div class="col-10">
                                        <label for="invert_logo"><img class="file-preview" style="width:666px;border:2px dashed #222;height: 242px"  src="<?php echo e(URL::asset('assets/media/banner/'.$data->invert_logo)); ?>"></label>
                                        <input type="hidden" name="invert_logo" value="<?php echo e($data->invert_logo); ?>">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">FavIcon
                                        <span class="text-danger"></span></label>
                                    <div class="col-10">
                                        <label for="fav_icon"><img class="file-preview" id="output" style="width:648px;border:2px dashed #222;height: 644px"  src="<?php echo e(URL::asset('assets/media/banner/'.$data->fav_icon)); ?>"></label>
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Store Meta Title
                                        <span class="text-danger">*</span></label>
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="<?php echo e($data->Store_Meta_Title); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea name="Store_Meta_Description"
                                            id="ktckeditor1"><?php echo e($data->Store_Meta_Description); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea name="Store_Meta_Keywords"
                                            id="ktckeditor2"><?php echo e($data->Store_Meta_Keywords); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea name="store_address"
                                            id="ktckeditor3" required><?php echo e($data->store_address); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">GSTIN
                                        <span class="text-danger"></span></label>
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="<?php echo e($data->GSTIN); ?>" id="GSTIN"
                                            name="GSTIN" required/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Order Emails From
                                        <span class="text-danger">*</span></label>
                                    <div class="col-10">
                                        <input id="Order_Emails_From" class="form-control" name='Order_Emails_From' placeholder='Write some tags' value='<?php echo e($data->Order_Emails_From); ?>'/>
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Order Emails To
                                        <span class="text-danger">*</span></label>
                                    <div class="col-10">
                                        <input id="Order_Emails_To" class="form-control" name='Order_Emails_To' placeholder='Write some tags' value='<?php echo e($data->Order_Emails_To); ?>'/>
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Order Emails BCC
                                        <span class="text-danger">*</span></label>
                                    <div class="col-10">
                                        <input id="Order_Emails_BCC" class="form-control" name='Order_Emails_BCC' placeholder='Write some tags' value='<?php echo e($data->Order_Emails_BCC); ?>'/>
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Contact Us Emails To
                                        <span class="text-danger">*</span></label>
                                    <div class="col-10">
                                        <input id="Contact_Us_Emails_To" class="form-control" name='Contact_Us_Emails_To' placeholder='Write some tags' value='<?php echo e($data->Contact_Us_Emails_To); ?>'/>
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Contact Us Emails BCC
                                        <span class="text-danger">*</span></label>
                                    <div class="col-10">
                                        <input id="Contact_Us_Emails_BCC" class="form-control" name='Contact_Us_Emails_BCC' placeholder='Write some tags' value='<?php echo e($data->Contact_Us_Emails_BCC); ?>'/>
                                    ...
                                    <label class="col-2 col-form-label">Date / Time Zone
                                        ...
                                        <div class="col-3">
                                            <select class="form-control" id="time_zone" name="time_zone" required>
                                                ...
                                                <option value="Africa/Abidjan" <?php echo e(($data->time_zone === 'Africa/Abidjan' )?'selected':''); ?>>Africa/Abidjan</option>											
                                                <option value="Africa/Accra" <?php echo e(($data->time_zone === 'Africa/Accra' )?'selected':''); ?>>Africa/Accra</option>											
                                                <option value="Africa/Addis_Ababa" <?php echo e(($data->time_zone === 'Africa/Addis_Ababa' )?'selected':''); ?>>Africa/Addis_Ababa</option>											
                                                <option value="Africa/Algiers" <?php echo e(($data->time_zone === 'Africa/Algiers' )?'selected':''); ?>>Africa/Algiers</option>
                                                <option value="Asia/Kolkata" <?php echo e(($data->time_zone === 'Asia/Kolkata' )?'selected':''); ?>>Asia/Kolkata</option>
                                            </select>
                                        </div>
                                </div>
                            </div>
    ...
    $(document).ready(function(){
      ...
      $('.crop_image').click(function(event){
          ...
          size: 'viewport'
            ...
            $.ajax({
                url:"<?php echo e(route('admin-store-cropimage')); ?>",
                type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/storeconfig/edit.blade.php ENDPATH**/ ?>