                                    ...
                                    <div class="card-header flex-wrap py-3">
                                        ...
                                        <div class="card-toolbar">
											...
											<div class="dropdown dropdown-inline">
											    <!--begin::Button-->
                                            <a href="<?php echo e(route('admin-productv-group')); ?>" class="btn btn-primary font-weight-bolder">
                                            ...
                                            <!--end::Button-->
												...
												<i class="la la-download"></i>Downloads</button>
...
var initTable1 = function() {
    ...
    var table = $('#kt_datatable1').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route('admin-product-datatables2')); ?>',
            type: 'POST',
            data: {
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                width: '100px',
                render:function(data, type, full, meta){
                    return '<?php echo e($StoreConfig->productIdprefix); ?>-'+data;
                }
            },
            {
                targets: 6,
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/product/index2.blade.php ENDPATH**/ ?>