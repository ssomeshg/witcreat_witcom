                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin-vendor-store')); ?>" id="formCreate" onsubmit="CKEditor1.updateSourceElement();">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <select class="form-control" id="role_id" name="role_id" required>
                                                           ...
                                                           <?php $__currentLoopData = $Role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $C): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($C->id); ?>"><?php echo e($C->role_name); ?></option>
                                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                        </div>
                                                    </div>
...
$('#pincode').select2({tags:true,placeholder:'Select Pincode'}).on('select2:close', function(){
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/witcreat/public_html/THESILKASTIC.COM/resources/views/admin/vendor/create.blade.php ENDPATH**/ ?>